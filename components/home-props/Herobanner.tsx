...
const HeroBanner = () => {
  return (
    <div className='mt-16'>   
      <section className="bg-center bg-no-repeat bg-[url('/hero.png')] bg-gray-200 bg-blend-multiply">
          <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
              <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">I could not get over it so i stayed under it</h1>
